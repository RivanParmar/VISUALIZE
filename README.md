...
# ⚠️ Work-In-Progress
![Android Studio Plugin](https://user-images.githubusercontent.com/77159650/170830891-21bda948-ca14-4783-977e-08f9ec8d5f79.png)

Currently, the project simply creates a split editor which works with Java and Kotlin files and looks as in the above screenshot and so the plugin is not yet ready for use. The "Design" tab will be where user will be able to write code visually. Again, this project is highly experimental and it may take much time to reach a stable state. Your contributions can make a lot of difference!
