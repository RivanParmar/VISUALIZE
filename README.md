...
# Work-In-Progress
Currently, the project has just been started and simply creates a split editor which works with Java and Kotlin files and so the plugin is not yet ready for use. Again, this project is highly experimental and it may take much time to reach a stable state. Your contributions can make a lot of difference!
